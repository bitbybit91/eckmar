...
# ---------------------------------------------------------------------------
# Auto-detect latest Monero release from GitHub API.
# Monero does NOT publish binaries as GitHub release assets — they are hosted
# on downloads.getmonero.org. The GitHub API is only used to get the tag name.
# ---------------------------------------------------------------------------
...
# Binaries are hosted on getmonero.org, NOT GitHub release assets
